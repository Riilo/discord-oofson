...
let logschannel = guild.channels.find(name, 'logs');
 messageDelete.logschannel.send(`The message: "${messageDelete.content}" by ${messageDelete.author.tag} was deleted. Let's hope you're better at hiding your porn.`)
});
