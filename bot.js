...
client.on("messageDelete", (messageDelete) => {
 ...
 message.author.sendMessage(`The message you sent: "${messageDelete.content}" by ${messageDelete.author.tag} was deleted. Let's hope you're better at hiding your porn.`);
});
